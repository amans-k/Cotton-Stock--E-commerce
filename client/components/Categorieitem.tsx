...
export default function Categorieitem({item,isSelected,onPress}: CategoryItemProps) {
  return (
    <TouchableOpacity className=' mr-4 items-center' onPress={onPress}>
    <View className={' w-14 h-14 rounded-full justify-center items-center mb-2 ${isSelected ? "bg-primary": " bg-surface"}'}>
