...
import CartItem from '@/components/Cartitem'  // Fixed: Changed Cartitem to CartItem
                ...
                <>
                    <ScrollView className='flex-1 px-4 mt-4' showsVerticalScrollIndicator={false}>
                        {cartItems.map((item, index) => (
                            <CartItem  // Fixed: Changed Cartitem to CartItem
                                key={index} 
                                item={item} 
                    ...
                    <View className='p-4 bg-white rounded-tl-3xl shadow-sm'>
                        {/* subTotal */}
